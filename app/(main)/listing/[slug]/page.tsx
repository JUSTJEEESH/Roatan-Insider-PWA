...
import { formatPriceRange, isOpenNow, formatAreaName, formatPhone } from '@/lib/utils';
  ...
  if (!business) {
    return (
      <div className="px-4 py-16 text-center">
        ...
        <p className="text-driftwood font-body mb-4">
          This listing could not be found.
        </p>
        <Link href="/explore" className="text-primary hover:underline font-body">
          Browse all listings
        </Link>
      </div>
    );
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="h-56 md:h-72 bg-gradient-to-br from-coconut-dark via-sand-dark to-coconut relative">
          ...
          <button
            ...
            className={cn(
              ...
              saved
                ? 'bg-coral text-white'
                : 'bg-white/80 text-driftwood hover:bg-white hover:text-coral'
            )}
          ...
          {/* Featured badge */}
          {business.isFeatured && (
            <Badge variant="featured" className="absolute bottom-4 left-4 z-10 shadow-sm">
              Featured
            </Badge>
          )}
        </div>
        ...
        <div className="px-4 pt-4">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <span className="text-lg text-driftwood font-body flex-shrink-0">
          ...
          {business.insiderTip && (
            <div className="mt-4 p-4 bg-gold/10 border border-gold/20 rounded-card">
              <p className="text-sm font-semibold text-charcoal font-display mb-1">
                Insider Tip
              </p>
          ...
          <div className="mt-5 grid grid-cols-2 gap-2 sm:grid-cols-4">
            {business.phone && (
              <a
                ...
                className="flex items-center justify-center gap-2 px-3 py-3 min-h-[44px] rounded-button bg-primary text-white text-sm font-body font-medium hover:bg-primary-dark transition-colors"
              >
                <Phone size={16} />
                Call
              </a>
            ...
            {business.whatsapp && (
              <a
                ...
                className="flex items-center justify-center gap-2 px-3 py-3 min-h-[44px] rounded-button bg-green-500 text-white text-sm font-body font-medium hover:bg-green-600 transition-colors"
              >
            ...
            {business.website && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-3 py-3 min-h-[44px] rounded-button bg-secondary text-white text-sm font-body font-medium hover:bg-secondary-dark transition-colors"
              >
                <Globe size={16} />
                Website
              </a>
            ...
            <a
              href={`geo:${business.latitude},${business.longitude}?q=${encodeURIComponent(business.name)}`}
              className="flex items-center justify-center gap-2 px-3 py-3 min-h-[44px] rounded-button bg-accent text-white text-sm font-body font-medium hover:bg-accent-dark transition-colors"
            >
              <Navigation size={16} />
              Directions
            </a>
          ...
          <div className="mt-6 space-y-3">
            ...
            {business.email && (
              ...
              >
                ...
                <span className="font-body">{business.email}</span>
              </a>
            )}
            {business.facebook && (
              <a
              ...
              >
                ...
                <span className="font-body">{business.facebook}</span>
              </a>
            )}
            {business.instagram && (
              <a
              ...
              >
                ...
                <span className="font-body">{business.instagram}</span>
              </a>
            )}
          </div>
              ...
              {DAY_NAMES.map((day) => {
                ...
                return (
                  <div
                    key={day}
                    className={cn(
                      'flex justify-between text-sm font-body',
                      isToday ? 'text-primary font-semibold' : 'text-driftwood'
                    )}
                  >
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {business.features.map((feature) => (
                  <Badge key={feature} variant="default" className="text-sm">
                    {feature}
                  </Badge>
                ))}
              </div>
          ...
          <div className="mt-6">
            <Link
              href={`/map?business=${business.slug}`}
              className="block bg-seafoam rounded-card p-4 hover:bg-seafoam-dark transition-colors"
            >
